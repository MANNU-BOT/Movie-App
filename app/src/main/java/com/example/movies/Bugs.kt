...
class Bugs : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when(bun.getString("key")){
            "one"->{window.statusBarColor= Color.parseColor("#ff0b445c")}
            "two"->{window.statusBarColor= Color.parseColor("#ff1b4641")}
            "three"->{window.statusBarColor= Color.parseColor("#ff1f91cc")}
            "four"->{window.statusBarColor= Color.parseColor("#ff024da1")}
            "five"->{window.statusBarColor= Color.parseColor("#ff444849")}
            else ->{window.statusBarColor= Color.parseColor("#ff0b445c")}}
